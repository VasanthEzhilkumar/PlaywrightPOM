...
export default  class ExcelUtil {
    public static getTestDataArray(sheet: string) {
        const result = excelToJson({
            sourceFile: 'C:/Users/vasanthkumar.ezhilku/Documents/WorkdayPW/src/data/testData.xlsx',
            columnToKey: {
                '*': '{{columnHeader}}',
            },
            sheetStubs: true,
    ...
    // public static getTestDataArray1(sheet: string) {
    //     const path = require('path');
    //     const dirName = path.dirname('../src/data/testData.xlsx');
    //     const fileName = dirName.filename('testData.xlsx');

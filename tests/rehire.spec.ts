...
test('Hire Process', async ({ }) => {
  ...
  for (const data of testData) {
    ...
    //   await hireEmployee.hireEmployeeJobDetails(data.HireDate, data.EmployeeType, data.JobProfile, data.TimeType, data.WorkShift, data.AdditionalJobClassifications,data.Position);
    ...
    //   await proxy.startProxy( '10285794');  //'10285794' // Hr Partner
    ...
    //   await proxy.startProxy( '10285794');
